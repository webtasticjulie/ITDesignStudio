  ...
  <nav>
    <ul>
      <li>
        ...
        <a href="index.php" data-transition="flip">Home</a>
      </li>

      <li>
        <a href="services.php" data-transition="flip">Services</a>
      </li>

      <li>
        <a href="service_providers.php" data-transition="flip">Service Providers</a>
      </li>
    </ul>
  </nav>